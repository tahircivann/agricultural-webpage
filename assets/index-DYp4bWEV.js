...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:pr,depthTest:!1,depthWrite:!1})}function Cf(){return new vr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ph(),fragmentShader:`
		...
		`,blending:pr,depthTest:!1,depthWrite:!1})}function Pf(){return new vr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ph(),fragmentShader:`
